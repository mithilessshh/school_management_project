...
firstw=Tk()
firstw.title("Mithilesh's School")
firstw.geometry("1600x1000+0+0")
label=Label(text="MITHS PUBLIC SCHOOL",font=("times new roman",35),bg="MediumOrchid2")
...
def second():
    global secondw
    secondw=Tk()
    secondw.title("Mithilesh's School")
    ...
    def distroy5():
        secondw.destroy()
        window()
    mainlabel= Label(secondw,text="Mithilesh's School", font=("times new roman", 35), bg="MediumOrchid2")
    mainlabel.pack(side=TOP, fill=X)
...
#================================droplist======================================
    ...
    box['values']=['SELECT','COMPUTER SCINCE','MECHANICAL','CIVIL','CSIT']
    box.current(0)
